...
function UserProfileFetcher() {
    // Hapus { userId } dari props karena kita akan ambil dari URL
    ...
    if (isLoading) {
        return <div style={{ textAlign: "center", padding: "20px", fontSize: "1.2em", color: "#007bff" }}>Loading user profile...</div>;
    }

    if (error) {
        return <div style={{ textAlign: "center", padding: "20px", color: "red" }}>Error: {error.message}</div>;
    }
